...
const checkBaggage = function (items) {
  const baggage = items.toLowerCase(); // lowercase first for everything it sensitive
...
// Use ANY data type, return data type, short-circuiting -> truty first
console.log(3 || 'Jonas');
console.log('' || 'Jonas');
console.log(true || 0);
...
let avg = 0;
for (const odd of odds) avg = avg + odd;
avg = avg / odds.length;
console.log(avg);
