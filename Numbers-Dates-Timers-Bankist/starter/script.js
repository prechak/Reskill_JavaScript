...
// Base 10 is 0 - 9      1/2 = 0.1  3/10 = 3.3333333
// Binary base is 2 is 0 1
console.log(0.1 + 0.2);
...
// Parsing
console.log(Number.parseInt('30px', 10)); // ,10 is What base it is
...
console.log(new Date('Wed Apr 24 2024 20:04:49'));
